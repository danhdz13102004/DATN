  ...
  return (
    <div className="flex min-h-screen font-satoshi bg-surface text-text">
      <div className="hidden md:flex flex-col justify-center items-center w-[45%] bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white p-16 relative overflow-hidden">
        ...
        <p className="text-lg opacity-90 max-w-[380px] text-center leading-relaxed z-10">Your career journey starts here.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-10 max-md:p-8">
        <div className="w-full max-w-[440px] text-center">
          ...
          <p className="mt-5 text-sm text-text-muted">
            ...
            <button type="button" className="bg-transparent border-none text-primary font-semibold cursor-pointer font-satoshi text-sm disabled:text-text-light disabled:cursor-not-allowed" onClick={handleResend} disabled={resendCooldown > 0}>
