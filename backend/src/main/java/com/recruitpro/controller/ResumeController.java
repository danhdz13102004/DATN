...
public class ResumeController {
    ...
    public ResponseEntity<ApiResponse<ResumeResponse>> getById(@PathVariable UUID id) {
        return ResponseEntity.ok(ApiResponse.ok(resumeService.findResponseById(id)));
    }
